	...
	public void radioButtonsTesting() throws InterruptedException {
	    ...
	    for (WebElement radioButton : allRadioButtons) {
	        ...
	        if (group1radiobutton.contains(radioButton)) {
	        	System.out.println("Group 1 Radio Button :"+radioButtonName);
	        ...
	        }  if (group2radiobutton.contains(radioButton)) {
	        	  System.out.println("Group 2 Radio Button :"+radioButtonName);
