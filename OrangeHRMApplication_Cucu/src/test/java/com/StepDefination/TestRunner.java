...
@CucumberOptions
(features="./OHRM/OHRM.feature",//give the folder name in which the feature file is created
 glue="./src/test/java/com/OHRM", // package name of the Java class in which methods are written
